...
import img1 from '../../Assets/product-2-sample.jpg'
import img2 from '../../Assets/product-1-sample.jpg'
function FeatureProductsMain() {
  return (
    <div className='flex flex-col  sm:gap-6 gap-4 sm:px-10 mt-5 px-6'>
    <ComponentHeading mainHeading={"FEATURE PRODUCT"} viewMoreButton={"VIEW MORE"}/>
...
export default FeatureProductsMain